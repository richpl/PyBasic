...
4640 GOTO 4710
4650 PRINT "HELPFUL INDIANS SHOW YOU WHERE TO FIND MORE FOOD"
4680 F = F + 14 
4690 GOTO 4710 
4700 REM ***MOUNTAINS*** 
...
6305 REM LOOP INTRODUCED BECAUSE THERE IS NO EXPONENT OPERATOR IN PYBASIC 
6309 REM LINE 6310 MODIFIED BY C.D.P. FOR COMPATIBILITY WITH CHIPMUNK BASIC 
6310 REM IF 100*RND(1)<100-(40/4^(E-1)) THEN 6410 
6311 ANSWER = 40 / 4 
6312 INCREMENT = 40 / 4 
6313 FOR I = 1 TO E - 2 
6314 FOR J = 1 TO 40 / 4 - 1 
6315 ANSWER = ANSWER + INCREMENT 
6316 NEXT J 
6317 INCREMENT = ANSWER 
6318 NEXT I 
6319 IF 100 * RND ( 1 ) < 100 - ANSWER THEN 6410  
